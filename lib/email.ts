    ...
    <tr>
      <td align="center">
        <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="max-width:560px;background:#FFFFFF;border-radius:12px;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,0.07);">
          ...
          <!-- Header -->
          <tr>
            <td style="background:linear-gradient(135deg,#FF6C00 0%,#FF440B 100%);background-color:#FF440B;padding:16px 32px;">
          ...
          <!-- Footer -->
          <tr>
            <td style="background-color:#FFF3E8;border-top:1px solid #FFD4B0;padding:16px 32px;">
              <p style="margin:0;font-size:12px;color:#999999;line-height:1.6;">
                Henry Barrows &middot;
                <a href="https://windo.ch" style="color:#FF440B;text-decoration:none;">windo.ch</a>
                &middot;
...
export function emailButton(label: string, href: string): string {
  return `<a href="${href}" style="display:inline-block;background-color:#FF440B;color:#FFFFFF;font-weight:600;font-size:14px;text-decoration:none;padding:12px 24px;border-radius:8px;margin-top:8px;">${label} →</a>`;
}

/** Reusable checkmark list item */
export function emailCheck(text: string): string {
  return `<tr><td style="padding:4px 0;font-size:14px;color:#444444;line-height:1.5;"><span style="color:#FF440B;font-weight:700;margin-right:8px;">✓</span>${text}</td></tr>`;
}
