...
import { BarChart, Target, Users, MapPin, ArrowRight } from 'lucide-react';
...
const MarketingAgencies = () => {
  const { t } = useLanguage();
  const projectUrl = getProjectUrlWithIndustry('Marketing Agency');

  return (
    <>
      <Helmet>
        <title>{t('marketing.hero.title')} | Windo</title>
        <meta name="description" content={t('marketing.hero.description')} />
        <meta name="keywords" content="marketing agency website, digital marketing, marketing services, marketing case studies, marketing agency" />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
        {/* Hero Section */}
        <div className="relative overflow-hidden">
          <div className="absolute inset-0 bg-[url('/images/marketing-bg.jpg')] bg-cover bg-center opacity-10 dark:opacity-5" />
          <div className="container mx-auto px-6 py-24 relative">
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                <span>{t('marketing.hero.button')}</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200 dark:border-gray-700">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                {t('marketing.features.services.title')}
              </h3>
              <p className="text-gray-600 dark:text-gray-400">
                {t('marketing.features.services.description')}
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200 dark:border-gray-700">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                {t('marketing.features.campaigns.title')}
              </h3>
              <p className="text-gray-600 dark:text-gray-400">
                {t('marketing.features.campaigns.description')}
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200 dark:border-gray-700">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                {t('marketing.features.clients.title')}
              </h3>
              <p className="text-gray-600 dark:text-gray-400">
                {t('marketing.features.clients.description')}
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200 dark:border-gray-700">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                {t('marketing.features.team.title')}
              </h3>
              <p className="text-gray-600 dark:text-gray-400">
                {t('marketing.features.team.description')}
              </p>
            </div>
          </div>
        </div>
