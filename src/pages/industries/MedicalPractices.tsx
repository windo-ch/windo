...
import { Stethoscope, Calendar, Users, MapPin, ArrowRight } from 'lucide-react';
...
const MedicalPractices = () => {
  const { t } = useLanguage();
  const projectUrl = getProjectUrlWithIndustry('Medical Practice');

  return (
    <>
      <Helmet>
        <title>{t('medical.hero.title')} | Windo</title>
        <meta name="description" content={t('medical.hero.description')} />
        <meta name="keywords" content="medical practice website, healthcare website, doctor website, medical services, patient portal" />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
        {/* Hero Section */}
        <div className="relative overflow-hidden">
          <div className="absolute inset-0 bg-[url('/images/medical-bg.jpg')] bg-cover bg-center opacity-10 dark:opacity-5" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200 dark:border-gray-700">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                {t('medical.features.services.title')}
              </h3>
              <p className="text-gray-600 dark:text-gray-400">
                {t('medical.features.services.description')}
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200 dark:border-gray-700">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                {t('medical.features.appointments.title')}
              </h3>
              <p className="text-gray-600 dark:text-gray-400">
                {t('medical.features.appointments.description')}
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200 dark:border-gray-700">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                {t('medical.features.portal.title')}
              </h3>
              <p className="text-gray-600 dark:text-gray-400">
                {t('medical.features.portal.description')}
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200 dark:border-gray-700">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                {t('medical.features.location.title')}
              </h3>
              <p className="text-gray-600 dark:text-gray-400">
                {t('medical.features.location.description')}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-windo-light/5 dark:bg-windo-light/10 py-16">
          <div className="container mx-auto px-6 text-center">
            ...
            <Link
              ...
              className="inline-flex items-center space-x-2 bg-windo-orange text-white px-8 py-4 rounded-lg hover:bg-windo-deeporange transition-colors text-lg font-medium"
            >
              <span>{t('medical.cta.button')}</span>
              <ArrowRight className="w-5 h-5" />
            </Link>
          </div>
        </div>
