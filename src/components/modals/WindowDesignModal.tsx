...
interface WindowDesignModalProps {
  isOpen: boolean;
  onClose: () => void;
}

const WindowDesignModal: React.FC<WindowDesignModalProps> = ({ isOpen, onClose }) => {
  const features = [
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              <p className="text-gray-600 dark:text-gray-400">
                Beautiful, functional websites that showcase your business in the best light.
                We create digital experiences that not only look great but also drive results.
              </p>
            </div>
          </div>
...
export default WindowDesignModal; 