    ...
    const confirmHtml = brandedEmail({
      ...
      body: `
        ...
        <table cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
          <tr><td style="padding:4px 0;font-size:14px;color:#444444;line-height:1.5;"><span style="color:#FF440B;font-weight:700;margin-right:8px;">✓</span>Ihre Ergebnisse sind sofort einsehbar</td></tr>
          <tr><td style="padding:4px 0;font-size:14px;color:#444444;line-height:1.5;"><span style="color:#FF440B;font-weight:700;margin-right:8px;">✓</span>Ich schaue mir Ihren Betrieb an und melde mich persönlich</td></tr>
          <tr><td style="padding:4px 0;font-size:14px;color:#444444;line-height:1.5;"><span style="color:#FF440B;font-weight:700;margin-right:8px;">✓</span>Kein Verkaufsgespräch — ehrliche Einschätzung</td></tr>
        </table>
  ...
  try {
    ...
    const confirmHtml = brandedEmail({
      ...
      body: `
        ...
        ${confirmLines.map(
          (line) =>
            `<p style="margin:0 0 10px;font-size:14px;color:#1C1C1C;line-height:1.6;padding:12px 16px;background:#FFF3E8;border-left:3px solid #FF440B;border-radius:0 6px 6px 0;">${line}</p>`
        ).join("")}
        <p style="margin:20px 0 0;font-size:13px;color:#888888;line-height:1.6;">
          Bei Fragen vorher: <a href="tel:+41791752020" style="color:#FF440B;text-decoration:none;">079 175 20 20</a>
          oder <a href="https://wa.me/41791752020" style="color:#FF440B;text-decoration:none;">WhatsApp</a>.
        </p>
      `,
    });
