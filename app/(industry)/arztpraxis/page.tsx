...
export const metadata: Metadata = {
  ...
  description: 'Professionelle Websites für Arztpraxen in der Schweiz. Mehr Patienten durch bessere Online-Sichtbarkeit. Direkt mit Henry — ab CHF 1\'490.',
...
const content: IndustryPageProps = {
  ...
  painPoints: [
    ...
    },
    {
      ...
      description:
        'Wer "Arztpraxis [Ihr Ort]" googelt, findet Praxen mit optimierten Einträgen und modernen Websites. Ohne lokale SEO und Google Business sind Sie unsichtbar.',
    },
  ],
  references: [
    {
  ...
  features: [
    ...
    'Ihre Fachgebiete, Ihr Team und Ihre Praxis optimal präsentiert',
    'Lokale SEO + Google Business — damit Patienten in Ihrer Region Sie finden',
    'Schnelle Ladezeiten (PageSpeed 90+) — Ihre Seite lädt, bevor der Patient blinzelt',
