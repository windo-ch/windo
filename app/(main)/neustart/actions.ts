    ...
    const confirmHtml = brandedEmail({
      ...
      body: `
        ...
        <table cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
          <tr><td style="padding:4px 0;font-size:14px;color:#444444;line-height:1.5;"><span style="color:#FF440B;font-weight:700;margin-right:8px;">✓</span>Ich schaue mir Ihre aktuelle Website an</td></tr>
          <tr><td style="padding:4px 0;font-size:14px;color:#444444;line-height:1.5;"><span style="color:#FF440B;font-weight:700;margin-right:8px;">✓</span>Ich baue einen ersten Entwurf — in der Regel innerhalb von 48 Stunden</td></tr>
          <tr><td style="padding:4px 0;font-size:14px;color:#444444;line-height:1.5;"><span style="color:#FF440B;font-weight:700;margin-right:8px;">✓</span>Ich schicke Ihnen den Entwurf per E-Mail oder rufe Sie an</td></tr>
        </table>
